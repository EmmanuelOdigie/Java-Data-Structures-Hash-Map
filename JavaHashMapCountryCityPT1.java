...
public class JavaHashMapCountryCityPT1 {// created public class 'JavaHashMapCountryCityPT1'
	...
	// object calls onto the '.put' function to put in values of the two String(txt) into the object
		...
		for(String cities: myCities.values()) {
			System.out.println(cities); // The values in object 'myCities' are now put into String 'cities'
			// the '.values()' is used to create the loop of the values after the first key - the cities in this case	
		}
...
// Result: display Country and cities separately